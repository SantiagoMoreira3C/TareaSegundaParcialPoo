...
namespace CarritoDeCompras
{
    ...
    public class Factura
    {
        ...
        /*
         * No utilizo el prinpcio de inversion
         * de dependecias en este proyecto
         * Porque Factura al ser una clase de alto nivel 
         * depende de bajo nivel como la DetalleFactura
         */
    }
}
